...
public class InputHandler {
	...
	public String handleCommand(String c) throws ArrayIndexOutOfBoundsException {
		/*
		 * Split around quotation marks to get data - always last element (will
		 * have length 1 if no data exists)
		 */
	...
	private String handleRead(String[] arguments)
			throws ArrayIndexOutOfBoundsException {
		String mrID = arguments[0];
		return accessController.read(mrID);
	}

	private String handleWrite(String[] arguments)
			throws ArrayIndexOutOfBoundsException {
		String mrID = arguments[0];
	...
	private String handleCreate(String[] arguments)
			throws ArrayIndexOutOfBoundsException {
		String mrID = arguments[0];
